...
namespace BackEndSAM.Controllers
{
    ...
    public class DummyListadoCuantificacionController : ApiController
    {
        ...
        public bool Post(string cerrar, string incompletos, string FolioAvisollegadaId, string FolioCuantificacionID, string cuantificacion, string token)
        {
            //List<ListadoCuantificacion> lstCuantificacion = new List<ListadoCuantificacion>();
        ...
        public bool Put(string cerrar, string incompletos, string FolioAvisollegadaId, string FolioCuantificacionID, string cuantificacion, string token)
        {
            //List<ListadoCuantificacion> lstCuantificacion = new List<ListadoCuantificacion>();
            //ListadoCuantificacion cuantificacion0 = new ListadoCuantificacion();
            //ListadoCuantificacion cuantificacion1 = new ListadoCuantificacion();
