...
namespace BackEndSAM.Controllers.Embarque.ListadoEmbarque
{
    ...
    public class ListadoEmbarqueController : ApiController
    {
        ...
        [HttpGet]
        public object GuardarEnvioEmbarque(string token, string lenguaje, int EmbarqueID, string NumeroEmbarque, string NumeroEmbarqueCliente, string FechaEnvio)
        {
            string payload = "";
            string newToken = "";
            ...
            if (tokenValido)
            {
                ...
                return ListadoEmbarqueBD.Instance.GuardarEnvioEmbarque(usuario.UsuarioID, lenguaje, EmbarqueID, NumeroEmbarque, NumeroEmbarqueCliente, FechaEnvio);
            }
            else
            {
                TransactionalInformation result = new TransactionalInformation();
