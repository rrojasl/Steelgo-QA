    ...
    public class DocumentoAvisoLlegadaController : ApiController
    {
        public object Get(int folio, string token)
        {
            ...
            if (tokenValido)
            {
                ...
                return DocumentosBd.Instance.ObtenerDocumentosFolioAvisoLlegada(folio, usuario);
            }
            else
            {
        ...
        public object Post(int folioAvisoLlegadaID,string tipoArchivoID, string token)
        {
            try
            {
                string newToken = "";
                    ...
                    if (httpRequest.Files.Count > 0)
                    {
                        ...
                        for (int i = 0; i < httpRequest.Files.Count; i++)
                        {
                            ...
                            lstArchivos.Add(new DocumentoPosteado
                            {
                                ...
                                TipoArchivoPaseSalida = tipoArchivoID,
                                Extencion = extencion
                            });
