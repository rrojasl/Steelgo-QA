...
namespace BackEndSAM.DataAcces.ServiciosTecnicos.ServiciosTecnicosGeneral
{
    public class ServiciosTecnicosGeneralBD
    {
        ...
        public object ObtenerListadoRequisicionEntregaPlacas(Sam3_Usuario usuario, int proyectoID, int proveedorID)
        {
            try
            {
                using (SamContext ctx = new SamContext())
        ...
        public object ObtenerListadoProveedoreEntregaPlacas(Sam3_Usuario usuario, int proyectoID, int patioID, int tipoPruebaID)
        {
            try
            {
                using (SamContext ctx = new SamContext())
