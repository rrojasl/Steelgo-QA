                ...
                using (SamContext ctx = new SamContext())
                {
                    ...
                    for (int i = 0; i < result.Count; i++)
                    {
                      ...
                      //cad.Append("{\"ReporteRTID\": \"" + result[i].ReporteRTID + "\", \"RequisicionID\":\"" + result[i].RequisicionID + "\", \"OrdenTrabajoID\":\"" + result[i].OrdenTrabajoID + "\",\"SpoolID\":\"" + result[i].SpoolID + "\", \"JuntaSpoolID\":\"" + result[i].JuntaSpoolID + "\", \"SpoolJunta\": \"" + result[i].JuntaSpoolID + "\", \"Junta\": \"" + result[i].Etiqueta + "\", \"NumeroControl\": \"" + result[i].SpoolID + "\", \"EtiquetaJunta\": \"" + result[i].NumeroRequisicion + "\", \"ClasificacionPND\": \"" + result[i].ClasificacionPND + "\", \"TipoPruebaID\": \"" + result[i].TipoPrueba + "\", \"Observaciones\": \"" + result[i].Observaciones + "\", \"CodigoAsme\": \"" + result[i].CodigoAsme + "\", \"NumeroPlacas\": " + numPlacas + ", \"Tamano\": 0, \"Densidad\": 0, \"ResultadoConciliacion\": \"N/A\", \"RazonNoConciliacion\": \"N/A\", \"InformacionResultados\": [" + detalleTemp + "], \"Accion\": 1, \"Activo\": 1, \"UsuarioModificacion\": 1, \"FechaModificacion\": \"" + DateTime.Now.ToString("yyyy-MM-dd") + "\", \"Estatus\": " + result[i].Estatus + ", \"Origen\": \"" + result[i].ORIGEN + "\" }");
                        cad.Append("{\"ReporteRTID\": \"" + result[i].ReporteRTID + "\", \"RequisicionID\":\"" + result[i].RequisicionID + "\", \"OrdenTrabajoID\":\"" + result[i].OrdenTrabajoID + "\",\"SpoolID\":\"" + result[i].SpoolID + "\", \"JuntaSpoolID\":\"" + result[i].JuntaSpoolID + "\", \"SpoolJunta\": \"" + result[i].JuntaSpoolID + "\", \"Junta\": \"" + result[i].Etiqueta + "\", \"NumeroControl\": \"" + result[i].SpoolID + "\", \"EtiquetaJunta\": \"" + result[i].NumeroRequisicion + "\", \"ClasificacionPND\": \"" + result[i].ClasificacionPND + "\", \"TipoPruebaID\": \"" + result[i].TipoPrueba + "\", \"Observaciones\": \"" + result[i].Observaciones + "\", \"CodigoAsme\": \"" + result[i].CodigoAsme + "\", \"NumeroPlacas\": " + numPlacas + ", \"Tamano\": \"" + result[i].Tamano+ "\", \"Densidad\": \"" + result[i].Densidad+ "\", \"ResultadoConciliacionID\": \"" + ((result[i].ResultadoConciliacionID == null)?(0):(result[i].ResultadoConciliacionID)) +"\", \"RazonNoConciliacionID\": \""+((result[i].RazonNoConciliacionID == null) ?(0):(result[i].RazonNoConciliacionID))+"\", \"InformacionResultados\": [" + detalleTemp + "], \"Accion\": 1, \"Activo\": 1, \"UsuarioModificacion\": 1, \"FechaModificacion\": \"" + DateTime.Now.ToString("yyyy-MM-dd") + "\", \"Estatus\": " + result[i].Estatus + ", \"Origen\": \"" + result[i].ORIGEN + "\" }");
                        if (i != (result.Count - 1))
                            cad.Append(',');
                    }
                    cad.Append(']');
