...
namespace DatabaseManager.Sam3
{
    public class ObjetosSQL
    {
        ...
        /// <param name="Parametros">Parametros que requiere el stord</param>
        /// <returns>Objeto DatatTable con la coleccion de datos</returns>
        public DataTable Tabla(string Stord, DataTable TablaSube, String NombreTabla, DataTable TablaSube1, String NombreTabla1,DataTable TablaSube2, String NombreTabla2, string[,] Parametros = null)
        {
