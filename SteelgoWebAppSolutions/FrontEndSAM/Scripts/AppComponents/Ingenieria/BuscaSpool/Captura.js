...
function CargarGridDynamic(posicion) {
    ...
    $("#grid_" + posicion).kendoGrid({
        ...
        columns: [
            ...
            { field: "TipoSalida", title: 'Tipo de Salida', filterable: getGridFilterableCellMaftec(), filterable: false, width: "130px", editor: RenderTipoSalida, attributes: { style: "text-align:left;" } },
            ...
            { field: "Cedula", title: 'Cedula', filterable: getGridFilterableCellMaftec(), filterable: false, width: "100px", editor: RenderCedula, attributes: { style: "text-align:left;" } },
            { field: "FamiliaAceroMaterial1", title: 'Acero', filterable: getGridFilterableCellNumberMaftec(), filterable: false, editor: RenderFamiliaAcero1, width: "80px", attributes: { style: "text-align:left;" } },
            { field: "FamiliaAceroMaterial2", title: 'Acero', filterable: getGridFilterableCellNumberMaftec(), filterable: false, editor: RenderFamiliaAcero2, width: "80px", attributes: { style: "text-align:left;" } },
