...
function CargarGridCapturaAvanceIntAcabado() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            { field: "Spool", title: _dictionary.columnNumeroControl[$("#language").data("kendoDropDownList").value()], width: "90px", filterable: getGridFilterableCellMaftec() },
            { field: "SistemaPintura", title: _dictionary.columnSistemaPintura[$("#language").data("kendoDropDownList").value()], width: "90px", filterable: getGridFilterableCellMaftec(), editor: RenderComboboxSistemaPintura },
            ...
            { field: "MetrosCuadrados", title: _dictionary.columnMetros2[$("#language").data("kendoDropDownList").value()], width: "100px", filterable: getGridFilterableCellNumberMaftec() },
