        ...
        if (data.length > 0) {
           ...
           // $("#grid").data("kendoGrid").dataSource.data(data);
            ...
            for (var i = 0; i < array.length; i++) {
                array[i].FechaRequisicion = new Date(ObtenerDato(array[i].FechaRequisicion, 1), ObtenerDato(array[i].FechaRequisicion, 2), ObtenerDato(array[i].FechaRequisicion, 3));//año, mes, dia
                ds.add(array[i]);
            }
