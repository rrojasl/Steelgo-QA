        ...
        if ($("#btnGuardarSup1").text() === _dictionary.lblGuardar[$("#language").val()]) {
            ...
            if (dataGrid.length > 0) {
                for (var i = 0; i < dataGrid.length; i++) {
                    if (dataGrid[i].CantAP > 0 || dataGrid[i].CantRDO > 0 || dataGrid[i].CantCOND > 0) {
                        dataGrid[i].RowOk = true;                        
                    } else {
                        if (dataGrid[i].CantS == 0) {
                            dataGrid[i].RowOk = true;
                        } else {
                            dataGrid[i].RowOk = false;
                            cont++;
                        }                        
                    }
                }                
                if (cont == 0) {
                    ...
                    displayNotify("msgErrorCapturaCantidad", "", "1");
                }
